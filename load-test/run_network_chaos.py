"""NetworkChaos driver: injects delay between product-service and api-gateway,
watches the gateway's circuit breaker state and product-service pod health."""
...
MANIFEST = Path(__file__).parent.parent / "k8s" / "chaos" / "resiliente" / "network-chaos.yaml"
RESULTS_DIR = Path(__file__).parent / "results" / "network-chaos"
